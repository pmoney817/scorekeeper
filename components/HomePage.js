          ...
          <div className="max-w-6xl mx-auto flex flex-col items-center">
            ...
            <div className="text-center animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-lg mx-auto font-body leading-relaxed mb-8">
                Pickleball positivity to fuel your mindset, curated drills to sharpen your skills, and tools to run your tournaments.
              </p>
        ...
        <section className="px-4 md:px-8 pb-8">
          <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { icon: Sparkles, title: 'Pickleball Positivity', desc: 'Fuel your mindset', color: 'ball', href: '/affirmations' },
